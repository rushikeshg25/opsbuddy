...
func (x *LogEntry) Reset() {
	*x = LogEntry{}
	mi := &file_proto_ingestion_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*LogEntry) Descriptor() ([]byte, []int) {
	return file_proto_ingestion_proto_rawDescGZIP(), []int{2}
}
...
const file_proto_ingestion_proto_rawDesc = "" +
	"\n" +
	"\x15proto/ingestion.proto\x12\x16opsbuddy.sdk.ingestion\"/\n" +
...
var file_proto_ingestion_proto_msgTypes = make([]protoimpl.MessageInfo, 3)
